...
//int ngay = Integer.parseInt(txtNgay.getText());
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (index == -1) {
            ...
            if (dto.getNgaytra() == null) {
                ...
                if (JOptionPane.showConfirmDialog(this, "BẠN CÓ CHẮT MUỐN XÓA GIAO DỊCH NÀY", "XÓA", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                    list.remove(index);
                    if (dao.delete(dto)) {
                        row.remove(index);
                        tableHienthi.updateUI();
    ...
    private void butInhoadonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butInhoadonActionPerformed
        ...
        if (dto.getNgaytra() == null) {
            ...
            frmhd.labeGiathue.setText(giathue);
            ...
            frmhd.labeTongGiaThue.setText(Tonggiathue);
            frmhd.labeLoaiPP.setText(dto.getLoaipp());
            frmhd.labePP.setText(String.valueOf(dto.getPhuphi()));
            frmhd.labeTong.setText(String.valueOf(dto.getTongphi()));
