...
public class GiaoDichDAO {
    ...
    public ArrayList<GiaoDichDTO> ReadbyGD() {
        ...
        try {
            ...
            while (rs.next()) {
                GiaoDichDTO dto = new GiaoDichDTO(rs.getString(1), rs.getString(2), rs.getString(3), rs.getInt(4), rs.getDate(5));
                list.add(dto);
            }
            return list;
        } catch (SQLException ex) {
    ...
    public ArrayList<GiaoDichDTO> ReadbyThongke() {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery(sql);
            while (rs.next()) {
                GiaoDichDTO dto = new GiaoDichDTO(rs.getString(1), rs.getString(2), rs.getString(3), rs.getInt(4), rs.getDate(5), rs.getDate(6), rs.getString(7), rs.getInt(8), rs.getInt(9));
                list.add(dto);
            }
            return list;
        } catch (SQLException ex) {
